                ...
                <div class="col-md-8 single-main">
                    <div class="single-grid">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <img src="<%#Eval("BLOGGORSEL")%>" style="width: 720px; height: 430px;" alt="" />
                                <br />
                                <h3 style="margin-top: 20px; color: #0094ff;"><%#Eval("BLOGBASLIK") %></h3>
                                <p><%#Eval("BLOGICERIK") %></p>
                            </ItemTemplate>
                        </asp:Repeater>
                    ...
                    <div class="content-form" style="background: #f4f5eb2b;">
                        ...
                        <form runat="server">
                            ...
                            <asp:TextBox ID="TextBox1" runat="server" placeholder="Kullanıcı Adınız" required></asp:TextBox>
                                    ...
                                    <asp:TextBox ID="TextBox3" runat="server" placeholder="Yorumunuz" TextMode="MultiLine" Height="100px" required></asp:TextBox>
